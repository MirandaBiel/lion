...
def filter_signal(signal, fs):
    ...
    # Definir a ordem do filtro Butterworth
    order = 2
    ...
    y = filtfilt(b, a, norm_signal)

    return y

def sqi_test(signal, filter_bool, fs):
    if filter_bool:
    ...
    print("SQI Perfusion: ", sqi_Perfusion)
    print("SQI Skewness: ", sqi_Skewness)
    print("SQI Kurtosis: ", sqi_Kurtosis)
    print("SQI Entropy: ", sqi_Entropy)
    print("SQI ZCR: ", sqi_Zero_Crossing_rate)
    print("SQI SNR: ", sqi_SNR)
...
plot_bvp_signal_1d(filter_signal(bvp_chrom, fs), "CHROM", fs)
plot_bvp_signal_1d(filter_signal(bvp_green, fs), "GREEN", fs)
plot_bvp_signal_1d(filter_signal(bvp_lgi, fs), "LGI", fs)
plot_bvp_signal_1d(filter_signal(bvp_pos, fs), "POS", fs)
plot_bvp_signal_1d(filter_signal(bvp_gbgr, fs), "GBGR", fs)
plot_bvp_signal_1d(filter_signal(bvp_ica, fs), "ICA", fs)
plot_bvp_signal_1d(filter_signal(bvp_omit, fs), "OMIT", fs)
plot_bvp_signal_1d(filter_signal(bvp_pbv, fs), "PBV", fs)
plot_bvp_signal_1d(filter_signal(bvp_pca, fs), "PCA", fs)
plot_bvp_signal_1d(filter_signal(bvp_ssr, fs), "SSR", fs)


d = sqi.PPG_analysis(filter_signal(bvp_green, fs), fs, 5, 'Skewness')
plot_bvp_signal_1d(d['Window'], "GREEN", fs)