...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(650, 10, 591, 151))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_metodo.sizePolicy().hasHeightForWidth())
        self.label_metodo.setSizePolicy(sizePolicy)
        ...
        self.gridGrafico.setRowStretch(0, 1)
        self.gridGrafico.setRowStretch(1, 1)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridSecondResults.addWidget(self.lineEdit_iq1, 2, 1, 1, 1)
        ...
        self.gridSecondResults.addWidget(self.lineEdit_iq2, 3, 1, 1, 1)
        ...
        self.gridSecondResults.addWidget(self.label_IQ1, 1, 0, 1, 1)
        ...
        self.gridSecondResults.addWidget(self.label_IQ2, 2, 0, 1, 1)
        self.label_IQ2_2 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_IQ2_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_IQ2_2.setObjectName("label_IQ2_2")
        self.gridSecondResults.addWidget(self.label_IQ2_2, 3, 0, 1, 1)
...
"color: rgb(255, 255, 255);")
        ...
        self.label.setGeometry(QtCore.QRect(650, 180, 611, 381))
        self.label.setText("")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_metodo.setItemText(2, _translate("Dialog", "CHROM"))
        self.comboBox_metodo.setItemText(3, _translate("Dialog", "LGI"))
        self.comboBox_metodo.setItemText(4, _translate("Dialog", "POS"))
        self.comboBox_metodo.setItemText(5, _translate("Dialog", "PBV"))
        self.comboBox_metodo.setItemText(6, _translate("Dialog", "PCA"))
        self.comboBox_metodo.setItemText(7, _translate("Dialog", "OMIT"))
        self.comboBox_metodo.setItemText(8, _translate("Dialog", "ICA"))
        self.comboBox_metodo.setItemText(9, _translate("Dialog", "SSR"))
        ...
        self.label_IQ2_2.setText(_translate("Dialog", "IQ3:"))
        self.pushButton_amostragem.setText(_translate("Dialog", "Atualizar"))
