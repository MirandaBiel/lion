...
class SuperConfig(QDialog):
    def __init__(self, main_window, *args, **kwargs):
        ...
        self.ui.checkBox_10.setCheckable(True)
        self.ui.checkBox_104.setCheckable(True)
        self.ui.checkBox_107.setCheckable(True)
        self.ui.checkBox_108.setCheckable(True)
        self.ui.checkBox_109.setCheckable(True)
        self.ui.checkBox_135.setCheckable(True)
        self.ui.checkBox_18.setCheckable(True)
        self.ui.checkBox_188.setCheckable(True)
        self.ui.checkBox_199.setCheckable(True)
        self.ui.checkBox_266.setCheckable(True)
        self.ui.checkBox_280.setCheckable(True)
        self.ui.checkBox_299.setCheckable(True)
        self.ui.checkBox_333.setCheckable(True)
        self.ui.checkBox_336.setCheckable(True)
        self.ui.checkBox_337.setCheckable(True)
        self.ui.checkBox_338.setCheckable(True)
        self.ui.checkBox_347.setCheckable(True)
        self.ui.checkBox_36.setCheckable(True)
        self.ui.checkBox_364.setCheckable(True)
        self.ui.checkBox_4.setCheckable(True)
        self.ui.checkBox_50.setCheckable(True)
        self.ui.checkBox_6.setCheckable(True)
        self.ui.checkBox_69.setCheckable(True)
        self.ui.checkBox_9.setCheckable(True)
